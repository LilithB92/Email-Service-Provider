...
urlpatterns = [
    ...
    path("recipient_detail/<int:pk>/",  cache_page(60 * 15)(RecipientDetailView.as_view()), name="recipient_detail"),
    ...
    path("message_detail/<int:pk>/",  cache_page(60 * 15)(MessageDetailView.as_view()), name="message_detail"),
    ...
    path("mailing_detail/<int:pk>/",  cache_page(60 * 15)(MailingDetailView.as_view()), name="mailing_detail"),
    path("mailing/new/", MailingCreateView.as_view(), name="mailing_create"),
    path("mailing/update/<int:pk>/", MailingUpdateView.as_view(), name="mailing_update"),
    path("mailing/delete/<int:pk>/", MailingDeleteView.as_view(), name="mailing_delete"),
    path("send_mailig/<int:pk>/",  cache_page(60 * 15)(SendMailingDetailView.as_view()), name="send_mailing"),
